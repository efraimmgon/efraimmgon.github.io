...
"undefined"!==typeof console&&(l=function(){return console.log.apply(console,d(arguments))},m=function(){return console.error.apply(console,d(arguments))});if("undefined"===typeof g||"undefined"===typeof h||"undefined"===typeof t)var t=function(){throw Error("cljs.core/*eval* not bound");};document.onload(function(){console.log("Hello world!");return document.getElementById("app").innerHTML="Hello world!"});